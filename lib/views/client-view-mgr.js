...
var ClientViewManager = Base.extend({
    ...
    setup: function(program) {
        ...
        var views = self.program.get_client_views(program);
        views.forEach(function(view) {
            ...
            if (_.has(self.view_classes, view.name)) {
                ...
                throw JuttleErrors.syntaxError('RT-INVALID-VIEW', {view: view.name,
        ...
        // Return a promise that resolves when all client views have
...
module.exports = ClientViewManager;
