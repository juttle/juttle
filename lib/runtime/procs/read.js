...
var Read = source.extend({
    ...
    initialize: function(options, params) {
        ...
        var adapterAllowedOptions = this.adapter.allowedOptions();
        if (adapterAllowedOptions) {
            var allAllowedOptions = AdapterRead.commonOptions.concat(adapterAllowedOptions);
            this.validate_options(allAllowedOptions);
        }
