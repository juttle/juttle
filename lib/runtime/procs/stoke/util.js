...
var dur = require('../../../runtime/types/juttle-moment').duration;
var gex = require('gex');
...
var juttle = require('../../../runtime/runtime'); // eslint-disable-line
...
function live_filter(filter) {
    ...
    if (filter && filter.filter_ast) {
        try {
            ...
            throw juttleErrors.compileError('FREE-TEXT-STOCHASTIC', {
