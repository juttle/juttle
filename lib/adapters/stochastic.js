...
class ReadStochastic extends AdapterRead {
    ...
    constructor(options, params) {
        ...
        if (this.type && this.type !== 'metric' && this.type !== 'event') {
            throw new errors.compileError('RT-METRICS-OR-EVENTS');
        }

        if (!options.from && !options.to) {
            throw new errors.compileError('RT-MISSING-TIME-RANGE-ERROR');
        }
        ...
        if (this.from.isBeginning()) {
            throw errors.compileError('RT-ADAPTER-UNSUPPORTED-TIME-OPTION', {
        ...
        if (!options.every && this.historic) {
            ...
            throw new errors.compileError('RT-DURATION-ERROR', {
                option: 'every',
