...
var JuttleMoment = Base.extend({
    ...
    toSimpleDurationString: function(d) {
    ...
    valueOf: function() {
        if (this.moment) {
            if (isNaN(this.moment.valueOf())) {
                return this.moment._i.toString();
            } else {
                return this.moment.toDate().toISOString();
            }
        } else {
            var d = this.duration;
            var simple = this.toSimpleDurationString(d);
            if (simple) {
                return simple;
            }
